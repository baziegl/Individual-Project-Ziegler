...
function scrawl_enqueue_scripts() {
...
add_action( 'admin_enqueue_scripts', 'scrawl_enqueue_scripts' );
 ...
 */
function scrawl_dismiss_admin_notice() {
...
add_action( 'wp_ajax_scrawl_jetpack_admin_notice', 'scrawl_dismiss_admin_notice' );
