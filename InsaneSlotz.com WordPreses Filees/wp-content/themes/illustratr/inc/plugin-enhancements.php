...
function illustratr_enqueue_scripts() {
...
add_action( 'admin_enqueue_scripts', 'illustratr_enqueue_scripts' );
 ...
 */
function illustratr_dismiss_admin_notice() {
...
add_action( 'wp_ajax_illustratr_jetpack_admin_notice', 'illustratr_dismiss_admin_notice' );
