...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'crio' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'crio' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'crio' ),
			'200'       => esc_html__( 'Light 200', 'crio' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'crio' ),
			'300'       => esc_html__( 'Book 300', 'crio' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'crio' ),
			'400'       => esc_html__( 'Normal 400', 'crio' ),
			'regular'   => esc_html__( 'Normal 400', 'crio' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'crio' ),
			'500'       => esc_html__( 'Medium 500', 'crio' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'crio' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'crio' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'crio' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'crio' ),
			'700'       => esc_html__( 'Bold 700', 'crio' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'crio' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'crio' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'crio' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'crio' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'crio' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'crio' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'crio' ),
		);
	}
