...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_html_e( 'Select image', 'crio' ); ?>',
	change: '<?php esc_html_e( 'Change image', 'crio' ); ?>',
	'default': '<?php esc_html_e( 'Default', 'crio' ); ?>',
	remove: '<?php esc_html_e( 'Remove', 'crio' ); ?>',
	placeholder: '<?php esc_html_e( 'No image selected', 'crio' ); ?>',
	frame_title: '<?php esc_html_e( 'Select image', 'crio' ); ?>',
	frame_button: '<?php esc_html_e( 'Choose image', 'crio' ); ?>',
} );
#>
