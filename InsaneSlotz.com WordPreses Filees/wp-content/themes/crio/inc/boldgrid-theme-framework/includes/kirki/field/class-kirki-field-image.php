...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_html__( 'Select image', 'crio' ),
				'change'       => esc_html__( 'Change image', 'crio' ),
				'default'      => esc_html__( 'Default', 'crio' ),
				'remove'       => esc_html__( 'Remove', 'crio' ),
				'placeholder'  => esc_html__( 'No image selected', 'crio' ),
				'frame_title'  => esc_html__( 'Select image', 'crio' ),
				'frame_button' => esc_html__( 'Choose image', 'crio' ),
			)
		);
	}
