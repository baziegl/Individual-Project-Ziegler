	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_html__( 'No File Selected', 'crio' ),
				'remove'               => esc_html__( 'Remove', 'crio' ),
				'default'              => esc_html__( 'Default', 'crio' ),
				'selectFile'           => esc_html__( 'Select File', 'crio' ),
				'standardFonts'        => esc_html__( 'Standard Fonts', 'crio' ),
				'googleFonts'          => esc_html__( 'Google Fonts', 'crio' ),
				'defaultCSSValues'     => esc_html__( 'CSS Defaults', 'crio' ),
				'defaultBrowserFamily' => esc_html__( 'Default Browser Font-Family', 'crio' ),
			)
		);
