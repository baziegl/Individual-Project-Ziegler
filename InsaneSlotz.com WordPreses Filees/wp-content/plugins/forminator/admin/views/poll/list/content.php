...
$search_keyword = null;
$is_search = false;
$search_polls_nonce = esc_attr( 'forminator-nonce-search-module' );
if ( isset( $_GET['search'] ) && check_admin_referer( $search_polls_nonce, $search_polls_nonce ) ) {
	...
	<div class="sui-box sui-summary sui-summary-sm <?php echo esc_attr( $this->get_box_summary_classes() ); ?>">
		...
		<div class="sui-summary-segment">
			...
			<div class="sui-summary-details">
				...
				<span class="sui-summary-sub"><?php printf( esc_html( _n( 'Active Poll', 'Active Polls', esc_html( $count_active ), Forminator::DOMAIN ) ), esc_html( $count_active ) ); ?></span>

				<form action="" method="get" id="forminator-search-polls" class="forminator-search-modules">
						...
						<div class="sui-col-lg-10 sui-col-md-12">
							...
							<div class="sui-form-field">
								...
								<div class="sui-control-with-icon">
									...
									<input type="text" name="search" value="<?php esc_attr_e( $search_keyword ); ?>" placeholder="<?php esc_attr_e( 'Search poll...', Forminator::DOMAIN ); ?>" id="forminator-polls-search" class="sui-form-control">
								</div>
					...
					<input type="hidden" name="page" value="forminator-poll" />
					<?php
						wp_nonce_field( $search_polls_nonce, $search_polls_nonce, false );
					?>
					...
					<span class="sui-list-detail">
						<?php if ( ! empty( $most_entry ) && get_post_status( $most_entry->form_id ) && 0 !== (int) $most_entry->entry_count ) { ?>
							<a href="<?php echo esc_url( admin_url( 'admin.php?page=forminator-poll-wizard&id=' . $most_entry->form_id ) ); ?>">
								<?php echo esc_html( forminator_get_form_name( $most_entry->form_id, 'poll' ) ); ?>
							</a>
						<?php
							} else {
								echo esc_html( '&mdash;' );
	...
	<div class="sui-box sui-message">
		...
		<div class="sui-message-content">
			...
			<?php else: // Search no-result message ?>
				...
				<p><?php esc_html_e( "We couldn't find any polls matching your search keyword. Perhaps try again?", Forminator::DOMAIN ); ?></p>
